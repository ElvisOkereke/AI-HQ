...
export default function SignUpForm({ onBack, onSignInClick }: SignUpFormProps) {
    ...
    <div className="flex flex-col items-center justify-center h-screen bg-gray-900 text-white font-sans">
      <div className="text-center w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="text-left text-sm text-gray-400">
            ...
            <ul className="list-disc list-inside mt-1 space-y-1">
              ...
              <li className={formData.password === formData.confirmPassword && formData.password ? 'text-green-400' : ''}>
                Passwords match
              </li>
            </ul>
          </div>
        ...
        <div className="mt-8 text-center text-gray-400 text-sm">
          <p>Already have an account? <button onClick={onSignInClick} className="text-blue-400 hover:text-blue-300">Sign in</button></p>
        </div>
      </div>
    </div>
  );
